...
<body>
    ...
    <div class="container">
        ...
        <p> IEEE International Symposium on Embedded Multicore/Manycore SoCs</p>
        <h2>Short Name</h2>
        <p>17th IEEE MCSoC- 224</p>
        ...
        <p>Communications</p>
        <h2>Submit Paper</h2>
        <p><a href="../paper_submit/submit4.php">https://esycon.info/N33011</a></p>
    </div>
    <div class="footer">
