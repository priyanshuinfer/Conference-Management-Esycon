...
<body>
    ...
    <div class="container">
        ...
        <p>2025 15th International Conference on Electrical Engineering (ICEENG)</p>
        <h2>Short Name</h2>
        <p>15th ICEENG 2025</p>
        ...
        <p>Jan 27, 2025</p>
        <h2>Topic Areas</h2>
        <p>Electrical & Power Engineering; Electrical engineering; Energy; Engineering; Powerline transmission; Reliability; Semiconductor</p>
        <h2>Submit Paper</h2>
        <p><a href="../paper_submit/submit1.php">https://esycon.info/N33008</a></p>
    </div>
    <div class="footer">
