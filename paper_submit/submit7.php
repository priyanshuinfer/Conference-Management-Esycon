...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0d0820; padding: 20px 10px;">
    ...
    <div class="container">
        <h1>International Conference on Robotics and Automation</h1>
        <p>Click on the name of the track to submit a paper; tracks without links are not accepting submissions at this time.</p>

        <!-- Important Dates -->
        <div class="header-row">
    <div>Register paper by <span class="date-box">Dec 27, 2025</span></div>
    <div>Review manuscript deadline <span class="date-box">Dec 27, 2025</span></div>
    <div>Invited talk abstract deadline <span class="date-box">Jan 16, 2026</span></div>
    <div>Invited talk presentation deadline <span class="date-box">Jan 16, 2026</span></div>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>ICRA 2025</td>
                    <td><a href="#">Electron Devices, Circuits and Systems</a></td>
                    <td></td>
                </tr>
                <tr>
                    <td>ICRA 2025</td>
                    <td><a href="#">Invited talks</a></td>
                    <td>Invited in ICEENG 2024</td>
                </tr>
                <tr>
                    <td>ICRA 2025</td>
                    <td><a href="#">Microwave, Antennas and Propagation</a></td>
                    <td></td>
                </tr>
