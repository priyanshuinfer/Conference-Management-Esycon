...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0d0820; padding: 20px 10px;">
    ...
    <div>Register paper by <span class="date-box">Apr 7, 2025</span></div>
    <div>Review manuscript deadline <span class="date-box">Apr 7, 2025</span></div>
    <div>Invited talk abstract deadline <span class="date-box">May 6, 2025</span></div>
    <div>Invited talk presentation deadline <span class="date-box">May 6, 2025</span></div>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>2025 ICNIPS</td>
                    <td><a href="submitted2.php">Electrical Power Engineering</a></td>
                    <td></td>
                </tr>
                <tr>
                    <td>2025 ICNIPS</td>
                    <td><a href="submitted3.php">Electron Devices, Circuits and Systems</a></td>
                    <td></td>
                </tr>
                <tr>
                    <td>2025 ICNIPS</td>
                    <td><a href="submitted4.php">Invited talks</a></td>
                    <td>Invited in ICEENG 2024</td>
                </tr>
                <tr>
                    <td>2025 ICNIPS</td>
                    <td><a href="submitted5.php">Microwave, Antennas and Propagation</a></td>
                    <td></td>
                </tr>
