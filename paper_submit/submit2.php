...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0d0820; padding: 20px 10px;">
    ...
    <div class="container">
        <h1>International Conference on Machine Learning</h1>
        <p>Click on the name of the track to submit a paper; tracks without links are not accepting submissions at this time.</p>

        <!-- Important Dates -->
        <div class="header-row">
    <div>Register paper by <span class="date-box">Nov 30, 2025</span></div>
    <div>Review manuscript deadline <span class="date-box">Nov 30, 2025</span></div>
    <div>Invited talk abstract deadline <span class="date-box">Dec 8, 2025</span></div>
    <div>Invited talk presentation deadline <span class="date-box">Dec 8, 2025</span></div>
</div>
